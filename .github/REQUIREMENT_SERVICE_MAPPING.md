...
| Loan Restructuring Tracking — SAAR-LRP-003                    | LoanService (POST /api/loans/{id}/restructure, GET /api/loans/applications/restructured, IsRestructured + RestructuredDate/Reason/NewEmi/NewTenure/NewRate fields, AddRestructureFields migration), React frontend (LoanDetail.tsx restructure dialog, Reports.tsx Tab 5 Restructured Loans) |
